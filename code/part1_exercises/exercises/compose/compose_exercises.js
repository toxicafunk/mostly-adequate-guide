...
var availablePrices = _.compose(join(', '), trace('after format'), map(_.compose(accounting.formatMoney, _.prop('dollar_value'))), _.filter(_.prop('in_stock')))
...
var fastestCar = _.compose(_.curry(function(s) { return s + ' is the fastest'; }), _.prop('name'), _.last, _.sortBy(_.prop('horsepower')));
